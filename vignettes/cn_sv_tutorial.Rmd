...
dlbcl_cell_lines = all_metadata %>% dplyr::filter(cohort == "DLBCL_cell_lines") %>% pull(sample_id)
these_sample_list = dlbcl_cell_lines
...
```{r sv_size}
#build plot
fancy_sv_sizedens(this_sample_id = "09-16981T",
                  vaf_cutoff = 0,
                  size_cutoff = 2,
                  chr_select = paste0("chr", c(1:22)),
