...
grch37_adaptive_sampling_targets = system.file("extdata","adaptive_sampling_targets.grch37.bed",package="GAMBLR.data") %>%
  read_tsv()
usethis::use_data(grch37_adaptive_sampling_targets, overwrite = TRUE)
