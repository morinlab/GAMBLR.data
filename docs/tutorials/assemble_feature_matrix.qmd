...
## Obtain metadata
In the [previous tutorial](./tutorials/getting_started.html), we have already
...
and store it in the data. Technically this step is not strictly necessary, as
...
The regions targeted by aSHM [are available](./resources/buncled_data.html) in
