...
There is a limited number of basic functions available with this package as its
main goal is data storage, so therefore the functions are not separated into
categories. Nevertheless, these are the basic functions available:
