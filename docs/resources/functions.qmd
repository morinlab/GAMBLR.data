...
included here do not require you to be Morin Lab member or have access to GSC.
...
* `get_ssm_by_region`: Returns maf data of the variants in the single given region.
...
This function is really just a wrapper for the singular version but works on many given regions.
