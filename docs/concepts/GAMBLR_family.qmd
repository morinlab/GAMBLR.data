...
flowchart LR
  ...
  F ==> E
  F ==> H{"GAMBL\nconsortium\nmember?"}
  H == <span style='background-color:#ea9fa4'>YES</span> ==> G
  C ==> G("GAMBLR.results")
  G ==> I("GAMBLR")
  H == <span style='background-color:#ea9fa4'>NO</span> ==> E
  classDef A,B font-size:18pt;
  style E fill:#d5bd97,stroke:#333,stroke-width:4,font-size:20px
  style I fill:#e3916a,stroke:#333,stroke-width:4,font-size:20px
```
